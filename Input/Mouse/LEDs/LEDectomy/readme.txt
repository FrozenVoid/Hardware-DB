...
4.Locate the LED(s), the main mouse LED can't be removed(its for providing movement info) but can be obscured by strategically placing black tape over the parts of plastic sheath from inside.
